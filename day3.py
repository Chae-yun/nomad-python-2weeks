...
def add_to_dict(dictionary = None, key = None, value = None):
...
def get_from_dict(dictionary = None, key = None):
  if type(dictionary) is not dict:
    print(f"You need to send a dictionary. You sent: {type(dictionary)}")
  elif key is None:
...
def update_word(dictionary = None, key = None, value = None):
  if type(dictionary) is not dict:
    print(f"You need to send a dictionary. You sent: {type(dictionary)}")
  elif value is None:
...
def delete_from_dict(dictionary = None, key = None):
  if type(dictionary) is not dict:
    print(f"You need to send a dictionary. You sent: {type(dictionary)}")
  elif key is None:
